...
export default function PrincipalMessageFlash({ institute }) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[1.75rem] border border-amber-200/75 bg-[linear-gradient(120deg,#fff8e7_0%,#fff1c7_16%,#fff8e7_35%,#fff1c7_58%,#fff8e7_100%)] p-5 shadow-[0_14px_32px_rgba(180,120,10,0.12)]">
      <div
      ...
      <div className="relative flex flex-wrap items-start gap-4">
        <div className="rounded-full border border-amber-300/80 bg-amber-500 px-4 py-2 text-xs font-black tracking-[0.22em] text-white uppercase shadow-[0_8px_18px_rgba(217,119,6,0.25)]">
          Principal&apos;s Message
        </div>
        <div className="min-w-0 flex-1">
          <p className="text-lg font-black text-slate-900 max-md:text-base">{principalName}</p>
          <p className="mt-2 text-sm leading-7 text-slate-700 max-md:leading-6">
            {principalMessage}
          </p>
        </div>
      </div>
