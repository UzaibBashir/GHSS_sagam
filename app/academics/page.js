        ...
        {!academicsEnabled ? (
          ...
          <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <article className="rounded-[2rem] border border-slate-200/80 bg-slate-950 p-6 text-white shadow-[0_20px_50px_rgba(15,23,42,0.14)] max-md:p-4">
              <p className="text-[0.72rem] font-extrabold tracking-[0.16em] text-amber-300 uppercase">Student Login</p>
              <h2 className="font-display mt-4 text-3xl font-semibold max-md:text-2xl">Academic materials are available after student sign-in</h2>
              <p className="mt-3 text-sm leading-7 text-slate-200">
                Enter the assigned roll number, choose your class and stream, and then provide the password issued by the school.
              </p>
              <div className="mt-6 rounded-[1.4rem] border border-white/12 bg-white/8 p-4 text-sm text-slate-200">
            ...
            <article className="glass-panel rounded-[2rem] border border-white/75 p-6 shadow-[0_20px_50px_rgba(15,23,42,0.07)] max-md:p-4">
              ...
              <h3 className="font-display mt-4 text-3xl font-semibold text-slate-950 max-md:text-2xl">Sign in to continue</h3>
