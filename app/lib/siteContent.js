...
export const ADMISSION_CONTENT = {
  ...
  eligibility: [
    ...
    "Addmission withou fee payment will be considered incomplete",
    "Documents will be verified during the admission process they must be original and valid as per norms",
    "Final admission is subject to seat availability and institutional norms.",
  ],
  requiredDocuments: [
    "Previous class marksheet",
    "School leaving or transfer certificate",
    "Aadhar, Bank Account photocopy and Ration-Card potocopy",
